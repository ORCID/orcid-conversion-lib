 ...
 *
 */
public class OrcidTranslatorV2 {

    public static String SCHEMA_LOCATION = "record_2.0/record-2.0.xsd";
    ...
    public OrcidTranslatorV2() {
        ...
        try {
            ...
            URL url = Resources.getResource(SCHEMA_LOCATION);
